export var data=[
    ...
    },
    {
		...
		button: 'Read More',
		image: 'https://media-exp1.licdn.com/dms/image/C510BAQGfV_BU0TXsAw/company-logo_200_200/0?e=2159024400&v=beta&t=sN7yK74kspJ6O-uQ8TBxCIfUg12PXvA5UEX_0f-rRtM',
    ...
    },
    {
		...
		quote:"My favorite things in life don’t cost any money. It’s really clear that the most precious resource we all have is time.",
		quoteby:"Steve Jobs",
		content:`<p>I am Dhanashree Revagade, a final-year computer science undergraduate student at Indian Institute of Information Technology Pune(IIIT Pune).</p>
		<p>&nbsp;</p>
		<p>This summer, I had the opportunity to complete an internship at FinIQ Consultancies Pvt. Ltd. Considering the difficult times the globe has been facing due to the COVID-19 pandemic, and especially the tech-industry being badly affected, it was grateful that FinIQ gave us an opportunity for a virtual internship.</p>
		<p>&nbsp;</p>
		<p>Let me take you through the internship drive and the overall internship experience through this article.</p>
		<p>&nbsp;</p>
		<p><u>The Internship Drive</u></p>
		<p><br /> It was a 1-day process. The first round started at around 9:30 am and by 7:00 in the evening, after all the rounds were completed, the selected candidates were announced. Before beginning the internship drive, we had to submit our resumes and all the candidates were assigned an ID based on their branch.</p>
		<p>&nbsp;</p>
		...
		<p>&nbsp;</p>
		<p>ROUND 1 - ESSAY WRITING AND BUSINESS PLAN FORMULATION</p>
		...
		<p>&nbsp;</p>
		<p>ROUND 2- APTITUDE TEST</p>
		<p>There was a 45 min aptitude test and questions on logical reasoning, language proficiency, verbal, non-verbal reasoning, etc were asked in the test. One had to be pretty quick in solving these questions to complete the whole test.</p>
		<p>&nbsp;</p>
		<p>ROUND 3 - CODING TEST</p>
		<p>There were two coding questions which were to be completed in 45 min. One was easy and the other one was medium level.</p>
		<p>&nbsp;</p>
		<p>&nbsp;</p>
		<p>&nbsp;</p>
		<p>&nbsp;</p>
		<p>ROUND 5 - GROUP DISCUSSION</p>
		...
		<p>&nbsp;</p>
		<p>ROUND 6 - PERSONAL INTERVIEW</p>
		<p>The personal interview had the most weightage in the overall process I felt.</p>
		<p>Firstly, in the technical part, I was asked some basic OOPs and sorting concepts. Then the questions related to Data Structures and Algorithms were asked. I was asked to give multiple approaches in the given question and explain which one should be the most preferred one. Then, after going through my resume, the interviewers asked me about my recent publication and the research experience. I was also asked to explain one of my projects in depth. Because one of my projects was in Machine Learning domain and I was also undergoing a machine learning online course at that time(which was mentioned in my resume), I was asked about some machine learning concepts. Then, I was also asked to solve a probability problem on pen and paper.</p>
		<p>&nbsp;</p>
		...
		<p>&nbsp;</p>
		<p><u>The Virtual Internship Experience</u></p>
		...
		<p>&nbsp;</p>
		<p><u>Some tips and takeaways</u></p>
		<ul>
		...
		<li>Practise explaining your projects beforehand so that you don&rsquo;t mess up during the interview.</li>
		</ul>
		<p>&nbsp;</p>
