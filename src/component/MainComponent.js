    ...
    return (
      <div>
        ...
        <Switch location={this.props.location}>
          ...
          <Route exact path='/editorials' exact component={() => <View type="editorials" />} />
          <Route exact path='/experience' exact component={() => <View type="experience" />} />
          <Route exact path='/achievments' exact component={() => <View type="achievments" />} />
